...
const Intro: FC = () => {
  return (
    <div id="intro-bg" className="bg-yellow-500 w-full h-screen relative">
      <div
        id="blob1"
        className="absolute ring-8 ring-amber-400 top-[25vh] sm:left-[2%] md:left-[15%] lg:left-[25%] z-0 shadow-2xl"
      ></div>
      <div
        id="blob2"
      ...
      <div id="bubble" className="absolute ring-2 ring-inset ring-zinc-800 flex justify-center items-center top-[60vh] xs:left-[60%] lg:left-[55%] xl:left-[55.5%]">
